...
public class ProductResourceIntTest {
    ...
    private static final String DEFAULT_PRODUCT_DEFINITION_ID = "AAAAA";
    private static final String UPDATED_PRODUCT_DEFINITION_ID = "BBBBB";
    ...
    public void initTest() {
        ...
        product = new Product();
        product.setProductDefinitionId(DEFAULT_PRODUCT_DEFINITION_ID);
...
//        product.setLiquidationGroup(DEFAULT_LIQUIDATION_GROUP);
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getProductDefinitionId()).isEqualTo(DEFAULT_PRODUCT_DEFINITION_ID);
...
//        assertThat(testProduct.getLiquidationGroup()).isEqualTo(DEFAULT_LIQUIDATION_GROUP);
    ...
    @Test
    public void checkProductDefinitionIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
        product.setProductDefinitionId(null);
    ...
    public void getAllProducts() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].productDefinitionId").value(hasItem(DEFAULT_PRODUCT_DEFINITION_ID.toString())))
    ...
    public void getProduct() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products/{id}", product.getId()))
            ...
            .andExpect(jsonPath("$.productDefinitionId").value(DEFAULT_PRODUCT_DEFINITION_ID.toString()))
    ...
    public void updateProduct() throws Exception {
        ...
        updatedProduct.setProductDefinitionId(UPDATED_PRODUCT_DEFINITION_ID);
...
//        updatedProduct.setLiquidationGroup(UPDATED_LIQUIDATION_GROUP);
        ...
        Product testProduct = products.get(products.size() - 1);
        assertThat(testProduct.getProductDefinitionId()).isEqualTo(UPDATED_PRODUCT_DEFINITION_ID);
